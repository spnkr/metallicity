...
%% 
mi = Mixture.load('halo5_800');



%% 
mi = Mixture(struct(	'save_as','halo3',...
						'em_optimal_iters',400,...
						'model_path','data/modeldata3.dat',...
						'obs_path','data/obsdata3_10000.dat',...
						'true_pi', Mixture.get_true_pi(3),...
						'graph',false));


im=1;
mi.save_as('halo3_1600')
mi.em(struct('max_iters',1600));
...
mi = Mixture(struct(	'save_as','halo5',...
						...
						'true_pi', Mixture.get_true_pi(5),...
						'graph',false));
					
im=2;
mi.save_as('halo5_1600')
mi.em(struct('max_iters',1600));
